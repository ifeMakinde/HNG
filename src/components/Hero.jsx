...
function Hero() {
  return (
    <>
      <main className="bg-[#e6f7ff] px-6 py-6">
        <div className="flex flex-col lg:flex-row justify-center items-center gap-4 lg:gap-8 md:flex-row m-auto max-w-[1440px] min-w-[320px] min-h-screen">
          ...
          <div className=" flex flex-1 flex-col items-center text-center lg:items-start gap-5 ">
            ...
            <p className="text-base lg:text-lg text-[#444] lg:text-left max-w-md ">
            ...
            <button className="capitalize py-4 px-8 bg-[#00aeff] font-semibold rounded-xl text-white text-lg tracking-wide ">
              Start learning
            </button>
          </div>
